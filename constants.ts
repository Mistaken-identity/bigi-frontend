...
export const TESTIMONIALS: Testimonial[] = [
    ...
    { name: "Fatima Amina.", location: "South C, Nairobi", stars: 5, feedback: "As a busy mom, Bigi is a lifesaver. I can order appliances and get them delivered for free without leaving the house. The cash on delivery is a huge plus for me.", imageUrl: "/assets/images/fatima" },
